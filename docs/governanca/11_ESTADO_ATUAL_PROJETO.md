...
- **revisão concluída até C6 (30/07/2026):** a PR foi **marcada como ready for review**; o **commit de correção C6** `ca4e118957a5d062b6e2990d6476fe8fe2d8494e` tratou os **dois apontamentos P2** da revisão automática (`README.md` deixou de repetir o gate e passou a apontar o registro vivo `11_ESTADO_ATUAL_PROJETO.md`; `14_MAPA_FONTES_CANONICAS_GITHUB.md` passou a exigir a data "quando houver"); o **diff consolidado tem exatamente 8 arquivos** e as **duas threads P2 foram respondidas e resolvidas**;
- **integração concluída (30/07/2026):** a **PR [#10](https://github.com/BrunoMNoronha/escambo-online/pull/10) foi mesclada** (`mergedAt` 2026-07-30T17:41:25Z) por **merge commit** `a73c4bf1aabecc7242b65e8e66573d892ae2dc6e` (pais `62cd24b6b793bac0d0e78641a6b9b6bd360db924` e head integrado `b4e56a6ce4a6137398c8bb26eda1db14c5f1a9e5`); **exatamente 8 arquivos** integrados; a branch `docs/eo-doc-007` foi **preservada** em `b4e56a6…`; **`DOC-007` está vigente na `main`**; **sem deploy**; o **Projeto ChatGPT ainda não foi modificado** e a **substituição manual dos anexos permanece não executada**;
- **próximo gate documental:** obter **autorização específica de Bruno para a substituição manual** da base do Projeto ChatGPT e, então, executá-la manualmente — definir o **campo de instruções** com o conteúdo de `01_INSTRUCOES_PROJETO_CHATGPT.md`; anexar **exatamente dois anexos** (`13_CONSTITUICAO_OPERACIONAL_CHATGPT.md` e `14_MAPA_FONTES_CANONICAS_GITHUB.md`); **remover os anexos antigos** do Projeto ChatGPT; executar a **verificação pós-substituição**; e registrar o **resultado real** em atualização documental posterior. Enquanto não houver autorização e execução, a base do Projeto ChatGPT permanece inalterada;
